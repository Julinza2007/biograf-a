...
function handleClick(event){
    ...
    if(event.target.classList.contains('secret')){
        if(event.target.textContent == '?'){
            document.body.innerHTML = `<h1>¿ESTOY ENAMORADO? Sí, de vos ${name}</h1><div id="container-img"><a href="poemas/poemas.html"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Heart_coraz%C3%B3n.svg/1200px-Heart_coraz%C3%B3n.svg.png" width="500px" height="525px"></a></div><div id="castillo_flotante"><a href="https://julinza2007.github.io/SAO/"><img src="aincrad.png"></a></div>`;
